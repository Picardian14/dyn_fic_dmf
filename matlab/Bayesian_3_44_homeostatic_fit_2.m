...
bo_opts = {'IsObjectiveDeterministic',false,'UseParallel',true,... %% Will be determinsitic so we do not estimate error
        ...
        'ParallelMethod','clipped-model-prediction','MaxTime',opt_time_1,...
...
close all;
filename = sprintf('Results/High_G_Range/NoiseEstimated.mat'); % Create filename
