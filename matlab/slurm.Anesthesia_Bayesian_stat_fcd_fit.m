...
#SBATCH --job-name=HCP_Deep_sameranges_12hs_stat_fcd_fit
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=64G
#SBATCH --cpus-per-task=12
#SBATCH --chdir=/network/iss/home/ivan.mindlin/dyn_fic_dmf/matlab
#SBATCH --output=outputs/HCP_Deep_sameranges_12hs_stat_fcd_fit.out
#SBATCH --error=outputs/HCP_Deep_sameranges_12hs_stat_fcd_fit.err
