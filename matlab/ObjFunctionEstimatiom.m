...
figure;
plotScenario( ...
    './Results/dyn_fcd/HCP_Awake_sameranges_12hs.mat', ...
    './Results/dyn_fcd/results_HCP_Deep_sameranges_12hs.mat', ...
...
figure;
plotScenario( ...
    './Results/dyn_fc/HCP_Awake_sameranges_12hs.mat', ...
    './Results/dyn_fc/HCP_Deep_sameranges_12hs.mat', ...
    'lr', logspace(0, 3, num_points_y), 'Learning Rate', 'log', ...
...
figure;
plotScenario( ...
    './Results/stat_fcd/HCP_Awake_sameranges_12hs.mat', ...
    './Results/stat_fcd/HCP_Deep_sameranges_12hs.mat', ...
...
figure;
plotScenario( ...
    './Results/stat_fc/HCP_Awake_sameranges_12hs.mat', ...
    './Results/stat_fc/HCP_Deep_sameranges_12hs.mat', ...
    'alpha', linspace(0.65, 0.85, num_points_y), 'Alpha', 'linear', ...
