...
#SBATCH --job-name=HCP_Awake_sameranges_12hs_stat_fc
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=64G
#SBATCH --cpus-per-task=12
#SBATCH --chdir=/network/iss/home/ivan.mindlin/dyn_fic_dmf/matlab
#SBATCH --output=outputs/HCP_Awake_sameranges_12hs_stat_fc.out
#SBATCH --error=outputs/HCP_Awake_sameranges_12hs_stat_fc.err
