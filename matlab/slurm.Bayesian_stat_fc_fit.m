...
#SBATCH --job-name=stat_fc_fit
#SBATCH --mail-type=END
#SBATCH --mail-user=
#SBATCH --mem=32G
#SBATCH --cpus-per-task=24
#SBATCH --output=outputs/stat_fc_fit.out
#SBATCH --error=outputs/stat_fc_fit.err
...
checkpoint_file = 'Results/stat_fc/results_v0.mat';
...
close all;
% save results
filename = sprintf('Results/stat_fc/seed_%d.mat',params.seed); % Create filename
