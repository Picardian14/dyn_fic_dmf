...
public:
  ...
  DYN_FIC_DMF(bp::dict d, size_t nb_steps, size_t N, bool return_rate, bool return_bold, bool return_fic) :
    DYN_FIC_DMFSimulator(struct2map(d), nb_steps, N, return_rate, return_bold, return_fic) {}
...
BOOST_PYTHON_MODULE(_DYN_FIC_DMF) {
    ...
    bp::class_<DYN_FIC_DMF, boost::noncopyable>("DYN_FIC_DMF", bp::init<bp::dict, size_t, size_t, bool, bool, bool>())
