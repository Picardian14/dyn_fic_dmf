...
def grid_step(args):
    ...
    # Statistical FC
    params['G'] = loadmat('../matlab/Results/stat_fc/results_deep_stat_fc.mat')['minEstimatedG_Deep']
    params['alpha'] = loadmat('../matlab/Results/stat_fc/results_deep_stat_fc.mat')['minEstimatedY_Deep']
    ...
    # Statistical FCD
    params['G'] = loadmat('../matlab/Results/stat_fcd/results_deep_stat_fcd.mat')['minEstimatedG_Deep']
    params['alpha'] = loadmat('../matlab/Results/stat_fcd/results_deep_stat_fcd.mat')['minEstimatedY_Deep']
    params['J'] = params['alpha'] * params['G'] * params['C'].sum(axis=0).squeeze() + 1
    rates, rates_inh, bold, fic_t = dmf.run(params, nb_steps)
    bold = bold[:, burnout:]
    filt_bold = filter_bold(bold.T, params['flp'], params['fhp'], params['TR'])
    ...
    # Dynamic FC
    params['G'] = loadmat('../matlab/Results/dyn_fc/results_deep_dyn_fc.mat')['minEstimatedG_Deep']
    params['lrj'] = loadmat('../matlab/Results/dyn_fc/results_deep_dyn_fc.mat')['minEstimatedY_Deep']
    ...
    # Dynamic FCD
    params['G'] = loadmat('../matlab/Results/dyn_fcd/results_deep_dyn_fcd.mat')['minEstimatedG_Deep']
    params['lrj'] = loadmat('../matlab/Results/dyn_fcd/results_deep_dyn_fcd.mat')['minEstimatedY_Deep']
    DECAY = np.exp(a + np.log(params['lrj']) * b)
    params['taoj'] = DECAY
    params['alpha'] = 0.75
    params["with_plasticity"] = True
...
def integrate_results(total_tasks, results_folder, N, wsize, bold_length):
    ...
    final_results_folder = "./Results/FittedSimulationsDeep"
...
def main():
    ...
    partial_results_folder = "./Results/PartialResultsDeep"
